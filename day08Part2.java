...
public class day08Part2 {
    public static void main(String[] args) {
        ...
        HashSet<String> nodesStart = new HashSet<>();
        HashSet<String> nodesEnd = new HashSet<>();
        ...
        while (true){
            for (char instruction : instructions) {
                if (instruction == 'L') {
                    for (String s : nodesStart) {
                        nodesEnd.add(destinations.get(s).get(0));
                    }
                } else {
                    for (String s : nodesStart) {
                        nodesEnd.add(destinations.get(s).get(1));
                    }
                }
                nodesStart.clear();
                nodesStart.addAll(nodesEnd);
                nodesEnd.clear();
                steps = steps.add(BigInteger.ONE);
                if (nodesStart.stream().allMatch(s -> s.endsWith("Z")))
                {
